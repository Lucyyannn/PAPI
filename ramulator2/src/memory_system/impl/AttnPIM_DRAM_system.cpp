...
class AttnPIMDRAMSystem final : public IMemorySystem, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IMemorySystem, AttnPIMDRAMSystem, "AttnPIMDRAM", "Attn PIM DRAM-based memory system.");
