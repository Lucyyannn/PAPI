...
class FCPIMDRAMSystem final : public IMemorySystem, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IMemorySystem, FCPIMDRAMSystem, "FCPIMDRAM", "FC PIM DRAM-based memory system.");
