...
class AttnPIMController final : public IDRAMController, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAMController, AttnPIMController, "Attn-PIM", "A Attn-PIM controller.");
  private:
