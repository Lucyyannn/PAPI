...
class FCPIMController final : public IDRAMController, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAMController, FCPIMController, "FC-PIM", "A FC-PIM controller.");
  private:
