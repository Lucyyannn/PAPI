...
class FCPIMLinearMapperBase : public IAddrMapper {
  public:
...
class FCPIMMap final : public FCPIMLinearMapperBase, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, FCPIMMap, "FC-PIM", "Applies a FC-PIM mapping to the address. (CH pCH Ra BG Ba Ro Co)");

  public:
    void init() override { };

    void setup(IFrontEnd* frontend, IMemorySystem* memory_system) override {
      FCPIMLinearMapperBase::setup(frontend, memory_system);
    }
