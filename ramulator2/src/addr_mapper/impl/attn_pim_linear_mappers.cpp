...
class AttnPIMLinearMapperBase : public IAddrMapper {
  public:
...
class AttnPIMMap final : public AttnPIMLinearMapperBase, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IAddrMapper, AttnPIMMap, "Attn-PIM", "Applies a Attn-PIM mapping to the address. (CH pCH Ra BG Ba Ro Co)");

  public:
    void init() override { };

    void setup(IFrontEnd* frontend, IMemorySystem* memory_system) override {
      AttnPIMLinearMapperBase::setup(frontend, memory_system);
    }
