...
class FCPIMLoadStoreTrace : public IFrontEnd, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IFrontEnd, FCPIMLoadStoreTrace, "FCPIMLoadStoreTrace", "FCPIM/Load/Store memory address trace.")
