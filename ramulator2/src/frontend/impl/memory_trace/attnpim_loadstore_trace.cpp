...
class AttnPIMLoadStoreTrace : public IFrontEnd, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IFrontEnd, AttnPIMLoadStoreTrace, "AttnPIMLoadStoreTrace", "AttnPIM/Load/Store memory address trace.")
    ...
    void tick() override {
      ...
      while(!req_full && !is_finished()) {
        ...
        switch (t.req_type) {
          ...
          case  4: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MAC_AP}); break;
