...
class FCPIM : public IDRAM, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IDRAM, FCPIM, "FC-PIM", "FC-PIM Device Model")
  ...
  public:
    struct Node : public DRAMNodeBase<FCPIM> {
      Node(FCPIM* dram, Node* parent, int level, int id) : DRAMNodeBase<FCPIM>(dram, parent, level, id) {};
    };
  ...
  private:
    ...
    void set_actions() {
      ...
      m_actions[m_levels["channel"]][m_commands["PREA"]] = Lambdas::Action::Channel::PREA<FCPIM>;
    ...
    void set_preqs() {
      ...
      m_preqs[m_levels["channel"]][m_commands["REFab"]] = Lambdas::Preq::Channel::RequireAllBanksClosed<FCPIM>;

      // Bank Preqs
      m_preqs[m_levels["bank"]][m_commands["REFsb"]] = Lambdas::Preq::Bank::RequireBankClosed<FCPIM>;
